package com.github.wucoding.forum.service.article.service.impl;

import com.github.wucoding.forum.api.model.enums.CollectionStatEnum;
import com.github.wucoding.forum.api.model.enums.CommentStatEnum;
...
import com.github.wucoding.forum.api.model.enums.PraiseStatEnum;
import com.github.wucoding.forum.api.model.exception.ExceptionUtil;
...
import com.github.wucoding.forum.core.util.ArticleUtil;
import com.github.wucoding.forum.core.util.SpringUtil;
import com.github.wucoding.forum.service.article.conveter.ArticleConverter;
import com.github.wucoding.forum.service.article.repository.dao.ArticleDao;
import com.github.wucoding.forum.service.article.repository.dao.ArticleTagDao;
...
import com.github.wucoding.forum.service.constant.EsFieldConstant;
import com.github.wucoding.forum.service.constant.EsIndexConstant;
import com.github.wucoding.forum.service.statistics.service.CountService;
...
public class ArticleReadServiceImpl implements ArticleReadService {
    ...
    /**
     * 查询帖子所有的关联信息，正文，分类，标签，阅读计数，当前登录用户是否点赞、评论过
     *
     * @param articleId
     * @param readUser
     * @return
