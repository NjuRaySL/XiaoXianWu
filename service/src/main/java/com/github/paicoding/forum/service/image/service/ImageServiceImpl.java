...
import com.github.wucoding.forum.core.async.AsyncExecute;
import com.github.wucoding.forum.core.async.AsyncUtil;
import com.github.wucoding.forum.core.mdc.MdcDot;
import com.github.wucoding.forum.core.util.MdImgLoader;
import com.github.wucoding.forum.service.image.oss.ImageUploader;
...
public class ImageServiceImpl implements ImageService {
    ...
    /**
     * 外网图片自动转存，添加了执行日志，超时限制；避免出现因为超时导致发布帖子异常
     *
     * @param content
     * @return
     */
