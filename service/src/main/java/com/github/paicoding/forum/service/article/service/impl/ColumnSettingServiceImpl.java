...
import com.github.wucoding.forum.service.article.conveter.ColumnArticleStructMapper;
import com.github.wucoding.forum.service.article.conveter.ColumnStructMapper;
import com.github.wucoding.forum.service.article.repository.dao.ArticleDao;
import com.github.wucoding.forum.service.article.repository.dao.ColumnArticleDao;
import com.github.wucoding.forum.service.article.repository.dao.ColumnDao;
...
import com.github.wucoding.forum.service.article.repository.entity.ColumnInfoDO;
import com.github.wucoding.forum.service.article.repository.params.SearchColumnArticleParams;
import com.github.wucoding.forum.service.article.repository.params.SearchColumnParams;
    ...
    public void sortColumnArticleApi(SortColumnArticleReq req) {
        ...
        if (activeDO != null && overDO != null && !activeDO.getId().equals(overDO.getId())) {
            ...
            if (activeSection > overSection) {
                // 当 activeSection 大于 overSection 时，表示帖子被向上拖拽。
                // 需要将 activeSection 到 overSection（不包括 activeSection 本身）之间的所有帖子的 section 加 1，
                ...
                // 向下拖动
                // 需要将 activeSection 到 overSection（包括 overSection）之间的所有帖子的 section 减 1
                columnArticleDao.update(null, Wrappers.<ColumnArticleDO>lambdaUpdate()
