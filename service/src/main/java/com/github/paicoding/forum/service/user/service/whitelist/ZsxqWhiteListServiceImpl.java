package com.github.wucoding.forum.service.user.service.whitelist;
...
import com.github.wucoding.forum.service.user.converter.UserStructMapper;
...
import com.github.wucoding.forum.service.user.service.ZsxqWhiteListService;
...
public class ZsxqWhiteListServiceImpl implements ZsxqWhiteListService {
    ...
    public void reset(Integer authorId) {
        ...
        // 密码重置为
        user.setPassword(userPwdEncoder.encPwd("wucoding"));
