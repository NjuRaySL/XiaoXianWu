...
import com.github.wucoding.forum.api.model.enums.OfficalStatEnum;
...
import com.github.wucoding.forum.service.article.repository.entity.ArticleDetailDO;
import com.github.wucoding.forum.service.article.repository.entity.ReadCountDO;
import com.github.wucoding.forum.service.article.repository.mapper.ArticleDetailMapper;
import com.github.wucoding.forum.service.article.repository.mapper.ArticleMapper;
import com.github.wucoding.forum.service.article.repository.mapper.ReadCountMapper;
...
public class ArticleDao extends ServiceImpl<ArticleMapper, ArticleDO> {
    ...
    public ArticleDTO queryArticleDetail(Long articleId) {
        ...
        if (showReviewContent(article)) {
            ...
            // 对于审核中的帖子，只有作者本人才能看到原文
            dto.setContent("### 帖子审核中，请稍后再看");
        }
        return dto;
    }
    ...
    public List<ArticleDO> listArticlesByUserId(Long userId, PageParam pageParam) {
        ...
        if (!Objects.equals(ReqInfoContext.getReqInfo().getUserId(), userId)) {
            // 作者本人，可以查看草稿、审核、上线帖子；其他用户，只能查看上线的帖子
