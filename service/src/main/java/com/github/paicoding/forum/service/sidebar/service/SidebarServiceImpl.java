...
import com.github.wucoding.forum.api.model.enums.ConfigTypeEnum;
import com.github.wucoding.forum.api.model.enums.SidebarStyleEnum;
import com.github.wucoding.forum.api.model.enums.rank.ActivityRankTimeEnum;
...
import com.github.wucoding.forum.api.model.vo.banner.dto.ConfigDTO;
import com.github.wucoding.forum.api.model.vo.rank.dto.RankItemDTO;
import com.github.wucoding.forum.api.model.vo.recommend.RateVisitDTO;
import com.github.wucoding.forum.api.model.vo.recommend.SideBarDTO;
import com.github.wucoding.forum.api.model.vo.recommend.SideBarItemDTO;
...
import com.github.wucoding.forum.service.config.service.ConfigService;
import com.github.wucoding.forum.service.rank.service.UserActivityRankService;
...
public class SidebarServiceImpl implements SidebarService {
    ...
    private SideBarDTO noticeSideBar() {
        ...
        return new SideBarDTO()
                .setTitle("关于小闲屋")
                // TODO 知识星球的
                .setImg("https://cdn.tobebetterjavaer.com/wucoding/main/wucoding-zsxq.jpg")
                .setUrl("https://wucoding.com/article/detail/2422000009961473")
                .setItems(items)
    ...
    private SideBarDTO hotArticles() {
        ...
        return new SideBarDTO().setTitle("热门帖子").setItems(items).setStyle(SidebarStyleEnum.ARTICLES.getStyle());
    }
    ...
    public SideBarDTO recommendByAuthor(Long authorId, Long articleId, long size) {
        ...
        return new SideBarDTO().setTitle("相关帖子").setItems(items).setStyle(SidebarStyleEnum.ARTICLES.getStyle());
    }
    ...
    private SideBarDTO subscribeSideBar() {
        return new SideBarDTO().setTitle("订阅").setSubTitle("楼仔")
                .setImg("//cdn.tobebetterjavaer.com/wucoding/a768cfc54f59d4a056f79d1c959dcae9.jpg")
