package com.github.wucoding.forum.web.front.home.helper;
...
import com.github.wucoding.forum.core.async.AsyncUtil;
...
import com.github.wucoding.forum.web.front.home.vo.IndexVo;
...
public class IndexRecommendHelper {
    ...
    public IndexVo buildIndexVo(String activeTab) {
        ...
        AsyncUtil.concurrentExecutor("首页响应")
                .async(() -> vo.setArticles(articleList(category.getCategoryId())), "帖子列表")
                .async(() -> vo.setTopArticles(topArticleList(category)), "置顶帖子")
