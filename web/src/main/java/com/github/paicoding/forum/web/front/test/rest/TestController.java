package com.github.wucoding.forum.web.front.test.rest;
...
import com.github.wucoding.forum.api.model.vo.Status;
import com.github.wucoding.forum.api.model.vo.constants.StatusEnum;
import com.github.wucoding.forum.core.autoconf.DynamicConfigContainer;
import com.github.wucoding.forum.core.dal.DsAno;
import com.github.wucoding.forum.core.dal.DsSelectExecutor;
import com.github.wucoding.forum.core.dal.MasterSlaveDsEnum;
import com.github.wucoding.forum.core.permission.Permission;
import com.github.wucoding.forum.core.permission.UserRole;
import com.github.wucoding.forum.core.senstive.SensitiveService;
import com.github.wucoding.forum.core.util.EmailUtil;
import com.github.wucoding.forum.core.util.JsonUtil;
import com.github.wucoding.forum.core.util.SpringUtil;
import com.github.wucoding.forum.service.chatai.ChatFacade;
import com.github.wucoding.forum.service.config.service.GlobalConfigService;
import com.github.wucoding.forum.service.statistics.service.StatisticsSettingService;
import com.github.wucoding.forum.service.statistics.service.impl.CountServiceImpl;
import com.github.wucoding.forum.web.front.test.vo.EmailReqVo;
...
public class TestController {
    ...
    public ResVo<String> email(EmailReqVo req) {
        ...
        if (StringUtils.isBlank(req.getTitle())) {
            req.setTitle("小闲屋的测试邮件发送");
        }
        if (StringUtils.isBlank(req.getContent())) {
            req.setContent("小闲屋的测试发送内容");
        } else {
