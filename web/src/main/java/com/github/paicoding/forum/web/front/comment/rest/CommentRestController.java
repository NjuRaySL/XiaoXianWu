package com.github.wucoding.forum.web.front.comment.rest;
...
import com.github.wucoding.forum.service.comment.service.CommentWriteService;
...
public class CommentRestController {
    ...
    public ResVo<List<TopCommentDTO>> list(Long articleId, Long pageNum, Long pageSize) {
        if (NumUtil.nullOrZero(articleId)) {
            return ResVo.fail(StatusEnum.ILLEGAL_ARGUMENTS_MIXED, "帖子id为空");
        }
