package com.github.wucoding.forum.web.front.login.wx.helper;

import com.github.wucoding.forum.api.model.vo.user.wx.BaseWxMsgResVo;
import com.github.wucoding.forum.api.model.vo.user.wx.WxImgTxtItemVo;
import com.github.wucoding.forum.api.model.vo.user.wx.WxImgTxtMsgResVo;
import com.github.wucoding.forum.api.model.vo.user.wx.WxTxtMsgResVo;
import com.github.wucoding.forum.core.util.CodeGenerateUtil;
import com.github.wucoding.forum.service.chatai.service.ChatgptService;
...
public class WxAckHelper {
    ...
    public BaseWxMsgResVo buildResponseBody(String eventType, String content, String fromUser) {
        ...
        if ("subscribe".equalsIgnoreCase(eventType)) {
            // 订阅
            textRes = "优秀的你一关注，二哥英俊的脸上就泛起了笑容。我这个废柴，既可以把程序人生写得风趣幽默，也可以把技术帖子写得通俗易懂。\n" +
                    "\n" +
        ...
        // 下面是回复图文消息
            ...
            imgTxt.setDescription("加入小闲屋的技术交流群，卷起来！");
        ...
        // 微信公众号登录
            ...
            textRes = "/:? 还在找其它资料么？\n" +
                    "\n" +
                    "[机智] 添加二哥的微信 itwanger 后，微信回复 “110”，即可获得 10 本校招/社招必刷八股文，以及小闲屋团队的原创手册《高并发手册》、《Spring 源码解析手册》、《设计模式手册》、《JVM 核心手册》、《Java 并发编程手册》、《架构选型手册》，工作面试两不误，工作面试两不误。\n" +
                    "\n" +
