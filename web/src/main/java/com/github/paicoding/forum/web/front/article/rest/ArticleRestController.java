package com.github.wucoding.forum.web.front.article.rest;

import com.github.wucoding.forum.api.model.context.ReqInfoContext;
import com.github.wucoding.forum.api.model.enums.DocumentTypeEnum;
import com.github.wucoding.forum.api.model.enums.NotifyTypeEnum;
import com.github.wucoding.forum.api.model.enums.OperateTypeEnum;
import com.github.wucoding.forum.api.model.vo.NextPageHtmlVo;
...
import com.github.wucoding.forum.api.model.vo.article.ContentPostReq;
...
import com.github.wucoding.forum.api.model.vo.notify.NotifyMsgEvent;
import com.github.wucoding.forum.api.model.vo.user.dto.BaseUserInfoDTO;
import com.github.wucoding.forum.core.common.CommonConstants;
import com.github.wucoding.forum.core.mdc.MdcDot;
import com.github.wucoding.forum.core.permission.Permission;
import com.github.wucoding.forum.core.permission.UserRole;
import com.github.wucoding.forum.core.util.JsonUtil;
import com.github.wucoding.forum.core.util.MarkdownConverter;
import com.github.wucoding.forum.core.util.SpringUtil;
...
import com.github.wucoding.forum.service.article.service.ArticleRecommendService;
import com.github.wucoding.forum.service.article.service.ArticleWriteService;
import com.github.wucoding.forum.service.article.service.CategoryService;
import com.github.wucoding.forum.service.article.service.TagService;
import com.github.wucoding.forum.service.notify.service.RabbitmqService;
import com.github.wucoding.forum.service.user.repository.entity.UserFootDO;
import com.github.wucoding.forum.service.user.service.UserFootService;
import com.github.wucoding.forum.service.user.service.UserService;
import com.github.wucoding.forum.web.component.TemplateEngineHelper;
import com.github.wucoding.forum.web.front.article.vo.ArticleDetailVo;
...
public class ArticleRestController {
     ...
     * 帖子详情页
     * - 参数解析知识点
     * - fixme * [1.Get请求参数解析姿势汇总 | RaySLLearning](https://hhui.top/spring-web/01.request/01.190824-springboot%E7%B3%BB%E5%88%97%E6%95%99%E7%A8%8Bweb%E7%AF%87%E4%B9%8Bget%E8%AF%B7%E6%B1%82%E5%8F%82%E6%95%B0%E8%A7%A3%E6%9E%90%E5%A7%BF%E5%8A%BF%E6%B1%87%E6%80%BB/)
     *
     * @param articleId
     * @return
     */
    ...
    public ResVo<Boolean> favor(@RequestParam(name = "articleId") Long articleId,
        ...
        if (article == null) {
            return ResVo.fail(StatusEnum.ILLEGAL_ARGUMENTS_MIXED, "帖子不存在!");
        }
     ...
     * 发布帖子，完成后跳转到详情页
     * - 这里有一个重定向的知识点
     * - fixme 博文：* [5.请求重定向 | RaySLLearning](https://hhui.top/spring-web/02.response/05.190929-springboot%E7%B3%BB%E5%88%97%E6%95%99%E7%A8%8Bweb%E7%AF%87%E4%B9%8B%E9%87%8D%E5%AE%9A%E5%90%91/)
     *
     * @return
     */
    @Permission(role = UserRole.LOGIN)
