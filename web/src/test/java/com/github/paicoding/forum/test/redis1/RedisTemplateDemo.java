package com.github.wucoding.forum.test.redis1;

import com.github.wucoding.forum.web.QuickForumApplication;
...
public class RedisTemplateDemo {
    ...
    public void testPut() {
        ...
        redisTemplate.opsForValue().set("itwanger", "小闲屋");
    ...
    public void testExecute() {
        ...
        redisTemplate.execute(new RedisCallback<Object>() {
            ...
            public Object doInRedis(RedisConnection connection) throws DataAccessException {
                ...
                connection.set("itwanger".getBytes(), "小闲屋".getBytes());
