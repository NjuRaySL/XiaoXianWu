package com.github.wucoding.forum.core.util.id;

import com.github.wucoding.forum.core.async.AsyncUtil;
import com.github.wucoding.forum.core.util.CompressUtil;
import com.github.wucoding.forum.core.util.id.snowflake.PaiSnowflakeIdGenerator;
import com.github.wucoding.forum.core.util.id.snowflake.SnowflakeProducer;

import static com.github.wucoding.forum.core.util.CompressUtil.int2str;
